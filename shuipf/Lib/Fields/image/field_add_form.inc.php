<table cellpadding="2" cellspacing="1" width="98%">
    <tr> 
        ...
        <td><input type="text" name="setting[size]"  size="10" class="input"></td>
    </tr>
    <tr> 
        <td>默认值</td>
    ...
    <tr> 
        <td>图像大小</td>
        <td>宽 <input type="text" name="setting[images_width]" value="" size="3" class="input">px 高 <input type="text" name="setting[images_height]" value="" size="3" class="input">px</td>
    </tr>
</table>